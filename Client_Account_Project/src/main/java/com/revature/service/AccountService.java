...
import com.revature.dto.JoinTableForClientAndAccountDTO;
...
public class AccountService {
	...
	public void validateFields(AddOrUpdateAccountDTO bankDto) throws InvalidInputException {
	...
	public List<JoinTableForClientAndBankAccountDTO> getAccountsWithSpecificAmount(String clientId,
		...
		if (amountGreaterThan != null && amountLessThan != null) {
			return this.AccountsDao.selectAccountsWithSpecificAmount(clientsId, amountGreater, amountLess);
		} else {
			return this.AccountsDao.selectAccountsById(clientsId);
		}
	...
	public Accounts editAccount(String cId, String accId, AddOrUpdateAccountDTO bankDto) throws InvalidInputException, SQLException {
		...
		Account Account = this.AccountsDao.updateAccount(clientId, accountId, bankDto);
