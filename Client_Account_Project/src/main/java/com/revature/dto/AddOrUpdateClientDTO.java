...
public class AddOrUpdateClientDTO {
	...
	public AddOrUpdateClientDTO(String First_Name, String Last_Name, String Address, String Phone_Number) {
		super();
	...
	public String toString() {
		return "AddOrUpdateClientDTO [First_Name=" + First_Name + ", Last_Name=" + Last_Name + ", Address=" + Address
				+ ", Phone_Number=" + Phone_Number + "]";
	}
}